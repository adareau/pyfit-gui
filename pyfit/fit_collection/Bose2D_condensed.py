# -*- coding: utf-8 -*-
'''----------------------------------------------------------
  file        : pyfit-gui/pyfit/fit_collection/Bose2D_condensed.py
  author      : A.  Dareau
  created     : 2015-07-21 10:34
  modified    : 2015-07-21 10:34
  description : Bose2D for partially condensed cloud (z=0)
                 (only for boseTF2D.py)
----------------------------------------------------------'''
...
# p = [offset, Ampl,sx,sy,cx,cy] (z=1)

def Bose2D((x,y),*p):
    g2_argument =  Gauss(x,1,p[2],p[4])*Gauss(y,1,p[3],p[5])*1
