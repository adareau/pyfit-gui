...
#
# Created: Tue Jan 27 15:50:15 2015
...
class Ui_PyFit(object):
    def setupUi(self, PyFit):
        ...
        self.folder_tree.setGeometry(QtCore.QRect(720, 30, 191, 192))
        self.folder_tree.setObjectName(_fromUtf8("folder_tree"))
        self.fitButton = QtGui.QPushButton(self.centralwidget)
        self.fitButton.setGeometry(QtCore.QRect(1000, 350, 75, 41))
        ...
        self.file_list.setGeometry(QtCore.QRect(930, 30, 201, 192))
        ...
        self.current_dir_txt.setGeometry(QtCore.QRect(720, 10, 411, 20))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
