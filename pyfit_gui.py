...
#
# Created: Mon Jul 13 12:04:25 2015
...
class Ui_PyFit(object):
    def setupUi(self, PyFit):
        ...
        self.plotWindow = GuiqwtScreen(self.centralwidget)
        self.plotWindow.setGeometry(QtCore.QRect(0, 17, 711, 491))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(720, 10, 431, 291))
        self.groupBox_2.setObjectName(_fromUtf8("groupBox_2"))
        self.hide_variables_button = QtGui.QPushButton(self.groupBox_2)
        self.hide_variables_button.setGeometry(QtCore.QRect(360, 260, 51, 21))
        self.hide_variables_button.setObjectName(_fromUtf8("hide_variables_button"))
        self.hide_variable_txt = QtGui.QLabel(self.groupBox_2)
        self.hide_variable_txt.setGeometry(QtCore.QRect(222, 261, 131, 20))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.refresh_file_list = QtGui.QPushButton(self.groupBox_2)
        self.refresh_file_list.setGeometry(QtCore.QRect(220, 238, 51, 21))
        self.refresh_file_list.setObjectName(_fromUtf8("refresh_file_list"))
        self.folder_tree = QtGui.QTreeView(self.groupBox_2)
        self.folder_tree.setGeometry(QtCore.QRect(10, 40, 191, 192))
        self.folder_tree.setObjectName(_fromUtf8("folder_tree"))
        self.current_dir_txt = QtGui.QLabel(self.groupBox_2)
        self.current_dir_txt.setGeometry(QtCore.QRect(10, 20, 411, 20))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        font.setKerning(True)
        ...
        self.progressBar.setGeometry(QtCore.QRect(280, 240, 141, 16))
        self.progressBar.setProperty("value", 100)
        self.progressBar.setObjectName(_fromUtf8("progressBar"))
        self.file_list = QtGui.QListView(self.groupBox_2)
        self.file_list.setGeometry(QtCore.QRect(220, 40, 201, 192))
        ...
        self.folder_tree_back.setGeometry(QtCore.QRect(10, 240, 31, 21))
        self.folder_tree_back.setObjectName(_fromUtf8("folder_tree_back"))
        self.groupBox_3 = QtGui.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(720, 310, 421, 251))
        self.groupBox_3.setObjectName(_fromUtf8("groupBox_3"))
        self.fitButton = QtGui.QPushButton(self.groupBox_3)
        self.fitButton.setGeometry(QtCore.QRect(290, 60, 75, 41))
        ...
        self.fitEditorTab.setGeometry(QtCore.QRect(10, 20, 271, 201))
